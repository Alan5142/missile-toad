...
# This function adds an ECS system to the project. It generates reflection code for the system and adds it to the list of systems.
# Arguments:
#   include: The include file for the system.
...
function (include_system include source name )
    ...
    set(SYSTEMS ${SYSTEMS} ${name} PARENT_SCOPE)
    set(SYSTEMS_INCLUDES ${SYSTEMS_INCLUDES} "#include \"${include}\"" PARENT_SCOPE)
    set(SYSTEMS_SOURCE_FILES ${SYSTEMS_SOURCE_FILES} ${source} PARENT_SCOPE)
endfunction()
...
void register_system(entt::meta_ctx& ctx)\n{\n")
    ...
    foreach(SYSTEM ${SYSTEMS})
        set(SYSTEM_GENERATED_FILES "${SYSTEM_GENERATED_FILES}    ${SYSTEM}::register_system(ctx);\n")
    endforeach()
    ...
    file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/systems.cpp" "${SYSTEM_GENERATED_FILES}")
endfunction()
...
void register_components(entt::meta_ctx& ctx)\n{\n")
    ...
    # Check if len of SYSTEMS is 0
    if (NOT COMPONENTS)
        set(COMPONENTS_GENERATED_FILES "${COMPONENTS_GENERATED_FILES}    unused(ctx);\n")
    endif()
    set(COMPONENTS_GENERATED_FILES "${COMPONENTS_GENERATED_FILES}}\n")

    # Write the generated code to a file.
    file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/components.cpp" "${COMPONENTS_GENERATED_FILES}")
endfunction()
