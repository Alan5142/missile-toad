...
TEST_CASE("GameDescriptor", "[core]")
{
    ...
    {
        auto descriptor = missileenginecore::load_game_descriptor(GAME_DESCRIPTOR).value();
    ...
    {
        auto descriptor = missileenginecore::load_game_descriptor(INVALID_GAME_DESCRIPTOR);
